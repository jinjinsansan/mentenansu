...
import { exchangeCodeForToken, getGoogleUserProfile, saveGoogleAuthData } from '../lib/googleAuth';
  ...
  useEffect(() => {
    const handleCallback = async () => {
      try {
        ...
        // ユーザープロフィールを取得
        const userProfile = await getGoogleUserProfile(tokenData.access_token);
        
        setMessage('認証情報を保存中...');
        
        // 認証情報を安全に保存
        saveGoogleAuthData(tokenData, userProfile);
